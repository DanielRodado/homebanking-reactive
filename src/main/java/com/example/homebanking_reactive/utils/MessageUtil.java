...
public class MessageUtil {
    ...
    public static final String NAME_INVALID = "Name invalid, cannot be empty";
    public static final String LAST_NAME_INVALID = "Last name invalid, cannot be empty";
    public static final String EMAIL_INVALID = "Email invalid, cannot be empty";
    public static final String PASSWORD_INVALID = "Password invalid, cannot be empty";
